...
SettingsDialog::SettingsDialog(std::weak_ptr<wui::window> transientWindow_,
    ...
    sectionList(std::make_shared<wui::list>()),
    okButton(std::make_shared<wui::button>(wui::locale("button", "ok"), std::bind(&SettingsDialog::OK, this), "green_button")),
    cancelButton(std::make_shared<wui::button>(wui::locale("button", "cancel"), [this]() { window->destroy(); }, "red_button")),
    cameraImg(std::make_shared<wui::image>(IMG_SETTING_CAMERA)),
    microphoneImg(std::make_shared<wui::image>(IMG_SETTING_MICROPHONE)),
    loudspeakerImg(std::make_shared<wui::image>(IMG_SETTING_LOUDSPEAKER)),
    accountImg(std::make_shared<wui::image>(IMG_SETTING_ACCOUNT)),
    connectionImg(std::make_shared<wui::image>(IMG_SETTING_CONNECTION)),
    preferencesImg(std::make_shared<wui::image>(IMG_SETTING_PREFERENCES)),
    recordImg(std::make_shared<wui::image>(IMG_SETTING_RECORD)),
    noSignalImg(std::make_shared<wui::image>(IMG_SETTING_NO_SIGNAL)),
    messageBox(std::make_shared<wui::message>(window)),

    timeMeter(),

    cameraSelect(std::make_shared<wui::select>()),
    cameraResolutionText(std::make_shared<wui::text>(wui::locale("settings", "camera_resolution"))),
    cameraResolutionSelect(std::make_shared<wui::select>()),
    cameraErrorText(std::make_shared<wui::text>()),
    cameraDevices(),
    ...
    microphoneSelect(std::make_shared<wui::select>()),
    microphoneSensitivityText(std::make_shared<wui::text>(wui::locale("settings", "microphone_sensitivty"))),
    microphoneSensitivitySlider(std::make_shared<wui::slider>(0, 100, wui::config::get_int("CaptureDevices", "MicrophoneGain", 80), [this](int32_t value) { microphone.SetGain(value); })),
    ...
    loudspeakerSelect(std::make_shared<wui::select>()),
    loudspeakerVolumeText(std::make_shared<wui::text>(wui::locale("settings", "loudspeaker_volume"))),
    loudspeakerSlider(std::make_shared<wui::slider>(0, 100, wui::config::get_int("AudioRenderer", "Volume", 100), [this](int32_t value) { audioRenderer.SetVolume(value); })),
    loudspeakerCheckButton(std::make_shared<wui::button>(wui::locale("settings", "loudspeaker_check"), [this]() { ringer.Ring(Ringer::RingType::SoundCheck); })),
    ...
    userNameText(std::make_shared<wui::text>(wui::locale("settings", "user_name"))),
    userNameInput(std::make_shared<wui::input>()),
    userChangeChandentialsLink(std::make_shared<wui::button>(wui::locale("settings", "show_change_chandentials"), std::bind(&SettingsDialog::ShowChangeChandentials, this), wui::button_view::anchor)),
    userLoginText(std::make_shared<wui::text>(wui::locale("settings", "user_login"))),
    userLoginInput(std::make_shared<wui::input>()),
    userPasswordText(std::make_shared<wui::text>(wui::locale("settings", "user_password"))),
    userPasswordInput(std::make_shared<wui::input>("", wui::input_view::password)),
    userPasswordConfirmText(std::make_shared<wui::text>(wui::locale("settings", "user_password_confirm"))),
    userPasswordConfirmInput(std::make_shared<wui::input>("", wui::input_view::password)),
    userName(UNCHANGED), userLogin(UNCHANGED), userPassword(UNCHANGED), userPasswordConfirm(UNCHANGED),

    connectionServerText(std::make_shared<wui::text>(wui::locale("settings", "connection_server"))),
    connectionServerInput(std::make_shared<wui::input>()),
    connectionLoginText(std::make_shared<wui::text>(wui::locale("settings", "user_login"))),
    connectionLoginInput(std::make_shared<wui::input>()),
    connectionPasswordText(std::make_shared<wui::text>(wui::locale("settings", "user_password"))),
    connectionPasswordInput(std::make_shared<wui::input>("", wui::input_view::password)),
    connectionAutoDetermineSpeedCheck(std::make_shared<wui::button>(wui::locale("settings", "auto_determine_network_speed"), [this]() { connectionSetSpeedManualCheck->turn(!connectionAutoDetermineSpeedCheck->turned()); UpdateSpeedInputs(); }, wui::button_view::radio)),
    connectionSetSpeedManualCheck(std::make_shared<wui::button>(wui::locale("settings", "set_network_speed_manual"), [this]() { connectionAutoDetermineSpeedCheck->turn(!connectionSetSpeedManualCheck->turned()); UpdateSpeedInputs(); }, wui::button_view::radio)),
    connectionInSpeedText(std::make_shared<wui::text>(wui::locale("settings", "input_network_speed"))),
    connectionInSpeedInput(std::make_shared<wui::input>()),
    connectionOutSpeedText(std::make_shared<wui::text>(wui::locale("settings", "output_network_speed"))),
    connectionOutSpeedInput(std::make_shared<wui::input>()),
    connectionDetermineSpeedNowButton(std::make_shared<wui::button>(wui::locale("settings", "determine_network_speed"), std::bind(&SettingsDialog::DetermineSpeedNow, this))),
    connectionCheckConnectivityNowButton(std::make_shared<wui::button>(wui::locale("settings", "check_connectivity"), std::bind(&SettingsDialog::CheckConnectivityNow, this))),
    ...
    prefTimerCheck(std::make_shared<wui::button>(wui::locale("settings", "show_timer"), []() {}, wui::button_view::switcher)),
    prefAutoAnswerCheck(std::make_shared<wui::button>(wui::locale("settings", "auto_answer"), []() {}, wui::button_view::switcher)),
    prefAutoConnectToConfCheck(std::make_shared<wui::button>(wui::locale("settings", "auto_connect_to_conference"), []() {}, wui::button_view::switcher)),
    prefShowAvatarCheck(std::make_shared<wui::button>(wui::locale("settings", "show_avatars"), []() {}, wui::button_view::switcher)),
    prefRequestTurnCamMicCheck(std::make_shared<wui::button>(wui::locale("settings", "request_turn_cam_mic"), []() {}, wui::button_view::switcher)),
    prefLanguageText(std::make_shared<wui::text>(wui::locale("settings", "language"))),
    prefLanguageSelect(std::make_shared<wui::select>()),
    prefAutoStartAppCheck(std::make_shared<wui::button>(wui::locale("settings", "auto_start_app"), []() {}, wui::button_view::switcher)),
    prefHideToTrayCheck(std::make_shared<wui::button>(wui::locale("settings", "hide_to_tray"), []() {}, wui::button_view::switcher)),
    prefAccentuateSpeakerCheck(std::make_shared<wui::button>(wui::locale("settings", "accentuate_speaker"), []() {}, wui::button_view::switcher)),
    prefUseDemonstrationWindowCheck(std::make_shared<wui::button>(wui::locale("settings", "use_demonstration_window"), []() {}, wui::button_view::switcher)),

    recordPathText(std::make_shared<wui::text>(wui::locale("settings", "record_path"))),
    recordPathInput(std::make_shared<wui::input>()),
    recordPathButton(std::make_shared<wui::button>("...", std::bind(&SettingsDialog::SelectPath, this))),
    recordMP3Check(std::make_shared<wui::button>(wui::locale("settings", "only_mp3_sound"), []() {}, wui::button_view::switcher)),
