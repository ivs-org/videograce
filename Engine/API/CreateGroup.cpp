...
Command::Command(int64_t parent_id_, const std::string &name_, const std::string &tag_, const std::string &password_, bool limited_, const std::string &guid_, int64_t owner_id_)
