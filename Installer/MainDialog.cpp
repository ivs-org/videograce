...
MainDialog::MainDialog()
    ...
    progressText(new wui::text("", wui::text_alignment::left, wui::text::tc, progressTextTheme)),
    progressBar(new wui::progress(0, 100, 0)),
    meetImage(new wui::image(IMG_MEET)),
    bigTitleText(new wui::text(wui::locale("installer", "big_title"), wui::text_alignment::center, wui::text::tc, bigTitleTheme)),
    versionText(new wui::text(std::string("v. ") + SYSTEM_VERSION, wui::text_alignment::center)),
    informationText(new wui::text(wui::locale("installer", !IsUninstaller() ? "preamble_install" : "preamble_uninstall"), wui::text_alignment::center)),
